...
public class CurrentTizhengBedService {
	private static Logger logger = Logger
			.getLogger(CurrentTizhengBedService.class);
	...
	public CurrentTizhengBedEntity getById(Integer id, Boolean devShow) {
		...
		if (id != null) {
			obj = (CurrentTizhengBedEntity) dbManager.getById(id,
	...
	public List<Object> getListByCondition(Map<String, Object> queryMap) {
		...
		QueryCondition qc = new QueryCondition(CurrentTizhengBedEntity.ID,
				QueryCondition.gt, "0");
		if (id != null) {
			qc.andCondition(new QueryCondition(CurrentTizhengBedEntity.ID,
		...
		if (devId != null) {
			qc.andCondition(new QueryCondition(CurrentTizhengBedEntity.DEV_ID,
		...
		if (havingbody != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.HAVINGBODY, QueryCondition.eq,
					havingbody));
		}
		if (havingbody_like != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.HAVINGBODY, QueryCondition.like,
					havingbody_like));
		}
		if (havingbody_isNull != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.HAVINGBODY, QueryCondition.isNull,
					havingbody_isNull));
		}
		if (havingbody_isNotNull != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.HAVINGBODY,
					QueryCondition.isNotNull, havingbody_isNotNull));
		}
		if (havingbody_in != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.HAVINGBODY, QueryCondition.in,
					havingbody_in));
		}
		if (alarmupdatetime_gt != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.ALARMUPDATETIME, QueryCondition.gt,
					alarmupdatetime_gt));
		}
		if (alarmupdatetime_ge != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.ALARMUPDATETIME, QueryCondition.ge,
					alarmupdatetime_ge));
		}
		if (alarmupdatetime_lt != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.ALARMUPDATETIME, QueryCondition.lt,
					alarmupdatetime_lt));
		}
		if (alarmupdatetime_le != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.ALARMUPDATETIME, QueryCondition.le,
					alarmupdatetime_le));
		}
		if (heart != null) {
			qc.andCondition(new QueryCondition(CurrentTizhengBedEntity.HEART,
		...
		if (breath != null) {
			qc.andCondition(new QueryCondition(CurrentTizhengBedEntity.BREATH,
		...
		if (devupdatetime_gt != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.DEVUPDATETIME, QueryCondition.gt,
					devupdatetime_gt));
		}
		if (devupdatetime_ge != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.DEVUPDATETIME, QueryCondition.ge,
					devupdatetime_ge));
		}
		if (devupdatetime_lt != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.DEVUPDATETIME, QueryCondition.lt,
					devupdatetime_lt));
		}
		if (devupdatetime_le != null) {
			qc.andCondition(new QueryCondition(
					CurrentTizhengBedEntity.DEVUPDATETIME, QueryCondition.le,
					devupdatetime_le));
		}
	...
	public List<Object> getListByCondition(Map<String, Object> queryMap,
		...
		list = dbManager.queryByConditions(CurrentTizhengBedEntity.class, qc,
				oc);
		int a = 0;
		if (devShow) {
			a++;
		...
		if (a > 0 && list != null && list.size() > 0) {
			...
			for (int i = 0; i < list.size(); i++) {
				CurrentTizhengBedEntity obj = (CurrentTizhengBedEntity) list
						.get(i);
				// 查询关联内容
				if (devShow != null && devShow.booleanValue() && obj != null
						&& obj.getDevId() > 0) {
	...
	public PageList getListByCondition(Map<String, Object> queryMap,
		...
		pagelist = dbManager.queryByCondition(CurrentTizhengBedEntity.class,
				qc, pageno, pagesize);
		return pagelist;
	}
	...
	public PageList getListByCondition(Map<String, Object> queryMap,
		...
		pagelist = dbManager.queryByConditions(CurrentTizhengBedEntity.class,
		...
		if (a > 0 && pagelist != null && pagelist.getResultList() != null
			...
			for (int i = 0; i < pagelist.getResultList().size(); i++) {
				CurrentTizhengBedEntity obj = (CurrentTizhengBedEntity) pagelist
						.getResultList().get(i);
				// 查询关联内容
				if (devShow != null && devShow.booleanValue() && obj != null
						&& obj.getDevId() > 0) {
		...
		if (id != null && id > 0) {
			...
			try {
				...
				if (delDev != null && delDev.booleanValue()) {
					CurrentTizhengBedEntity currentTizhengBed = (CurrentTizhengBedEntity) dbManager
							.getById(id, CurrentTizhengBedEntity.class);
					if (currentTizhengBed != null
							&& currentTizhengBed.getDevId() != null) {
						dbManager.delNoTransaction(
								currentTizhengBed.getDevId(), DevEntity.class);
					}
				}
