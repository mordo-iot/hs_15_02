		...
		public List<Object> getListByCondition(Map<String,Object> queryMap) {
			...
			QueryCondition qc = new QueryCondition(CurrentBedEntity.ID, QueryCondition.gt, "0");				
					...
					if(level_in!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.LEVEL, QueryCondition.in, level_in));}
																if(alarmupdatetime!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.ALARMUPDATETIME, QueryCondition.eq, alarmupdatetime));}
		            if(alarmupdatetime_like!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.ALARMUPDATETIME, QueryCondition.like, alarmupdatetime_like));}
		            if(alarmupdatetime_isNull!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.ALARMUPDATETIME, QueryCondition.isNull, alarmupdatetime_isNull));}
		            if(alarmupdatetime_isNotNull!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.ALARMUPDATETIME, QueryCondition.isNotNull, alarmupdatetime_isNotNull));}
		            if(alarmupdatetime_in!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.ALARMUPDATETIME, QueryCondition.in, alarmupdatetime_in));}
		            ...
		            if(power_in!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.POWER, QueryCondition.in, power_in));}
																if(devupdatetime!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.DEVUPDATETIME, QueryCondition.eq, devupdatetime));}
		            if(devupdatetime_like!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.DEVUPDATETIME, QueryCondition.like, devupdatetime_like));}
		            if(devupdatetime_isNull!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.DEVUPDATETIME, QueryCondition.isNull, devupdatetime_isNull));}
		            if(devupdatetime_isNotNull!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.DEVUPDATETIME, QueryCondition.isNotNull, devupdatetime_isNotNull));}
		            if(devupdatetime_in!=null){qc.andCondition(new QueryCondition(CurrentBedEntity.DEVUPDATETIME, QueryCondition.in, devupdatetime_in));}
