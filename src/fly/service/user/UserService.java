		...
		public List<Object> getListByCondition(Map<String,Object> queryMap) {
			...
			QueryCondition qc = new QueryCondition(UserEntity.ID, QueryCondition.gt, "0");				
					...
					if(permissions_in!=null){qc.andCondition(new QueryCondition(UserEntity.PERMISSIONS, QueryCondition.in, permissions_in));}
																if(createdate!=null){qc.andCondition(new QueryCondition(UserEntity.CREATEDATE, QueryCondition.eq, createdate));}
		            if(createdate_like!=null){qc.andCondition(new QueryCondition(UserEntity.CREATEDATE, QueryCondition.like, createdate_like));}
		            if(createdate_isNull!=null){qc.andCondition(new QueryCondition(UserEntity.CREATEDATE, QueryCondition.isNull, createdate_isNull));}
		            if(createdate_isNotNull!=null){qc.andCondition(new QueryCondition(UserEntity.CREATEDATE, QueryCondition.isNotNull, createdate_isNotNull));}
		            if(createdate_in!=null){qc.andCondition(new QueryCondition(UserEntity.CREATEDATE, QueryCondition.in, createdate_in));}
																if(lstlogindate!=null){qc.andCondition(new QueryCondition(UserEntity.LSTLOGINDATE, QueryCondition.eq, lstlogindate));}
		            if(lstlogindate_like!=null){qc.andCondition(new QueryCondition(UserEntity.LSTLOGINDATE, QueryCondition.like, lstlogindate_like));}
		            if(lstlogindate_isNull!=null){qc.andCondition(new QueryCondition(UserEntity.LSTLOGINDATE, QueryCondition.isNull, lstlogindate_isNull));}
		            if(lstlogindate_isNotNull!=null){qc.andCondition(new QueryCondition(UserEntity.LSTLOGINDATE, QueryCondition.isNotNull, lstlogindate_isNotNull));}
		            if(lstlogindate_in!=null){qc.andCondition(new QueryCondition(UserEntity.LSTLOGINDATE, QueryCondition.in, lstlogindate_in));}
