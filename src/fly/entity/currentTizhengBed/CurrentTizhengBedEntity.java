package fly.entity.currentTizhengBed;
...
/**
 * @Title: Entity
 * @Description: 体征床垫当前信息表
 * @author feng.gu
 * @date 2015-08-20 13:57:05
 * @version V1.0
 * 
 */
@TableDescription(name = "mordo_state_current_tizheng_bed")
public class CurrentTizhengBedEntity implements java.io.Serializable {
