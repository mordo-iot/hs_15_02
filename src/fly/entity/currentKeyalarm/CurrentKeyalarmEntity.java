package fly.entity.currentKeyalarm;
...
/**   
 * @Title: Entity
 * @Description: 一键报警当前信息
 * @author feng.gu
 * @date 2015-09-07 14:15:34
 * @version V1.0   
 *
 */
@TableDescription(name = "mordo_state_current_keyalarm")
public class CurrentKeyalarmEntity implements java.io.Serializable {
