package fly.entity.currentGateway;
...
/**   
 * @Title: Entity
 * @Description: 室内网关当前信息
 * @author feng.gu
 * @date 2015-09-07 14:15:32
 * @version V1.0   
 *
 */
@TableDescription(name = "mordo_state_current_gateway")
public class CurrentGatewayEntity implements java.io.Serializable {
