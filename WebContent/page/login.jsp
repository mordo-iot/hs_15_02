<%@page import="fly.front.entity.LoginResult"%>
  ...
  <head>
	...
	<script type="text/javascript">
	  ...
	  function login() {
	    ...
	    $.ajax({
          type:"post",
          url:"<%=path %>/loginController.do?login",
          dataType:"text",
          async:false,
      ...
      <div class="Login">
        <div class="LoginBlock">
          ...
          <div class="LoginBlock2">
            <div>
              <p class="username">
                <span>用</span><span>户</span><span>名</span>：<input id="username" name="username" value="${loginResult['userName']}" onkeydown="if(event.keyCode==13){$('#password').focus();}">
              </p>
              <p class="username">
