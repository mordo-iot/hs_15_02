...
<html>
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          if (d.parents != null && d.parents.length > 0) {
            html2top = "<li onclick=\"getPositionInfo('0');\" style=\"cursor: pointer;\">所有位置</li>";  //导航栏
  ...
  <body>
    <input type="hidden" id="currentPositionId" name="currentPositionId">
